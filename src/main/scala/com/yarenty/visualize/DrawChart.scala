...
import com.yarenty.bezier.Casteljau
...
object DrawChart {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val chartNormalized = XYLineChart(normalized, "just normalized")
    val chartNormalized2 = XYLineChart(new Casteljau().normalize(normalized), "just normalized 2")

    val l = normalized.map(x => x._2)
    val chartCasteljau = XYLineChart(new Casteljau().extendWithIndex(l, 4), "casteljau")
    val chartCubic = XYLineChart(new Casteljau().extendCubicWithIndex(l, 4), "Bexier Cubic")
    ...
    chartNormalized2.show("Interpolation - 2", (1000, 600), true)
    chartCasteljau.show("Casteljau - normalized", (1000, 600), true)
    chartCubic.show("Cubis Bexier - normalized", (1000, 600), true)
